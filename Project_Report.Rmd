...
abstract: |
  This report undertakes a comprehensive examination of survey response data quality through a comparison of probability-based methods with non-probability-based methods, using the ACSSM dataset. Various relevant survey response metrics are applied to the dataset variables, enabling the assessment and comparison of response data quality between probability-based and non-probability-based survey methods. The comparative analysis demonstrates that probability-based methods consistently exhibit better data quality in terms of less number of careless survey responses compared to non-probability methods, supporting the hypothesis that non-probability-based methods have worse data quality. 
